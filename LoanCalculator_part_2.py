...
if choice == 'm':
    ...
    nMonths = ceil(principal/mPayment)
    if nMonths == 1:
        print(f"It will take {nMonths} month to repay the loan.")
    else:
        print(f"It will take {nMonths} months to repay the loan.")
else:
    nMonths = int(input("Enter the number of months: "))
    mPayment = ceil(principal/nMonths)
    if principal % nMonths == 0:
        print(f"Your monthly payment = {mPayment}.")
    else:
        lastpayment = principal - (nMonths - 1) * mPayment
        print(f"Your monthly payment = {mPayment} and the last payment = {lastpayment}")
